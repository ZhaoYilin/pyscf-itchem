...
class Log(object):
    ...
    def __init__(self, name, head_banner, foot_banner, timer):
        """Initialize a ScreenLog object.
...
class TimerGroup(object):
    ...
    def report(self, log):
        ...
        log.hline()
        log('{0:<20s}{1:<20s}'.format('Label','Total'))
        log.hline()
...
End of the PYSCF-ITA program.

Thank you for using PYSCF-ITA Ψ(◉ཅ◉)Ψ!
